					...
					case 5: //Vitashel Molecular
						switch (sub_selected){
							...
							case 1://Install Molecular
                                                                printf("Instalando Molecular...\n");
								sprintf(con_data, "Instalando Molecular...\n");
							...
							case 3://Vitashell in NEAR
							        if (doesDirExist("vs0:app/NPXS10000/MLCL2")) {sprintf(con_data, "Ya tienes instalado VITASHELL en NEAR!!\n");
								strcat(log_text,con_data); }
                                                                else if (doesFileExist("vs0:app/NPXS10000/sce_sys/pic0.png")) {printf("Instalando VITASHELL en NEAR\ny haciendo copia de la Base de Datos\n");
								{for (i = 0; i < 15; i++) {
		                                                printf(".");
		                                                vshIoUmount(i * 0x100, 0, 0, 0); // id, unk1, unk2, unk3 (flags ?)
							...
							case 4://Near restore
								...
								strcat(log_text,con_data); }
								else if (doesDirExist("vs0:app/NPXS10000/MLCL2") && doesFileExist("ur0:tai/boot_config.txt")) {printf("Restaurando NEAR \n");
								{for (i = 0; i < 15; i++) {
		                                                printf(".");
		                                                vshIoUmount(i * 0x100, 0, 0, 0); // id, unk1, unk2, unk3 (flags ?)
								...
								strcat(log_text,con_data);
                                                                sceKernelDelayThread(6 * 1000 * 1000);
	                                                        scePowerRequestColdReset();}
								else if (doesDirExist("vs0:app/NPXS10000/MLCL2") && doesFileExist("vs0:tai/boot_config.txt")) {printf("Restaurando NEAR \n");
								{for (i = 0; i < 15; i++) {
		                                                printf(".");
		                                                vshIoUmount(i * 0x100, 0, 0, 0); // id, unk1, unk2, unk3 (flags ?)
								...
								strcat(log_text,con_data);
                                                                sceKernelDelayThread(6 * 1000 * 1000);
	                                                        scePowerRequestColdReset();}
                                                                else if (doesDirExist("vs0:app/NPXS10000/MLCL") && doesFileExist("ur0:tai/boot_config.txt")) {printf("Restaurando NEAR \n");
								{for (i = 0; i < 15; i++) {
		                                                printf(".");
		                                                vshIoUmount(i * 0x100, 0, 0, 0); // id, unk1, unk2, unk3 (flags ?)
								...
								strcat(log_text,con_data);
                                                                sceKernelDelayThread(6 * 1000 * 1000);
	                                                        scePowerRequestColdReset();}
								else if (doesDirExist("vs0:app/NPXS10000/MLCL") && doesFileExist("vs0:tai/boot_config.txt")) {printf("Restaurando NEAR \n");
								{for (i = 0; i < 15; i++) {
		                                                printf(".");
		                                                vshIoUmount(i * 0x100, 0, 0, 0); // id, unk1, unk2, unk3 (flags ?)
